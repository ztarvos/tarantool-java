...
public class SQLConnection implements Connection {
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        checkNotClosed();
        return new SQLPreparedStatement(this, sql, autoGeneratedKeys == RETURN_GENERATED_KEYS);
    }
    ...
    protected JDBCBridge executeUpdate(String sql, Object ... args) throws SQLException {
        checkNotClosed();
        try {
