...
public interface TarantoolConnection extends Connection {
     ...
     *
     * @param space Space to query. Should be configured in tarantool.cfg
     * @param id    tuple which contains only primary key
     ...
     * @param space Space to query. Should be configured in tarantool.cfg
     * @param id    tuple which contains only primary key
     * @param ops   update operations Operation
     * @return affected tuple or null
     */
     ...
     * @param space Space to query. Should be configured in tarantool.cfg
     * @param id    tuple which contains only primary key
     * @param ops   update operations {@link org.tarantool.core.Operation}
     * @return tuples affected
     */
     ...
     *
     * @param space  Space to query. Should be configured in tarantool.cfg
     * @param index  Index to use. Should be configured in tarantool.cfg
     * @param offset a int.
     * @param limit  a int.
     * @param keys   Keys to match. If a tuple matches more than one key, it's
     *               returned twice.
